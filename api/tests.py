...
#     def setUp(self):
#         user1 = User.objects.create_user(username='user1',password='75397561az')
...
#     def test_user_order_endpoint_retrives_only_authenticated_user_orders(self):
...
class ProductAPITestCase(APITestCase):
    ...
    def test_only_admins_can_delete_product(self):
        # test normal user cannot delete -note that this be its own method
